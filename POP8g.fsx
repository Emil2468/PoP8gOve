...
let rec boundingBox (fig : figure) : (point * point) =
    ...
    | Mix (f1, f2) -> ((min (fst (fst (boundingBox f1))) (fst (fst(boundingBox f2))), min (snd (fst(boundingBox f1))) (snd (fst (boundingBox f2)))),
                        ((max (fst (snd (boundingBox f1))) (fst (snd (boundingBox f2)))), (max (snd (snd (boundingBox f1))) (snd (snd (boundingBox f2))))))
